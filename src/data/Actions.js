export let opA = [
  {
    msg: [
      ...
      "¡Ah! Y si estás en una emergencia y pedís un móvil policial, también pueden tomarte la denuncia en tu domicilio. 🏠",

      "☝️ Igualmente, tené en cuenta que siempre podés llamar o chatear con el 📱 144. Te daremos toda la información, contención y asesoramiento que necesitás."
    ]
  }
];
...
export let opB = [
  {
    msg: [
      "En los hogares y refugios de la Ciudad, las mujeres que viven situaciones de violencia de género y sus hijos reciben la seguridad y contención que necesitan. 🏠",
      "¿Qué se les ofrece? 👇",

      "✔️ Asistencia psicológica y asesoramiento legal gratuito.",
      "✔️ Capacitación e inserción laboral.",
      "✔️ Herramientas para que puedan reinsertarse en la sociedad. ",

      "Si querés saber más podes llamarnos de lunes a viernes de 9:30 a 16:30 h. al 📞 5030-9740"
    ]
  }
];
